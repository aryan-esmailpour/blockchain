      ...
      return stream
        ...
        .then(statusResponse => {
          ...
          if (statusBody.status !== ClientBatchStatus.Status.COMMITTED) {
            ...
            const message =
              statusBody.invalidTransactions.length > 0
          ...
          return new Promise(resolve => setTimeout(() => {
            ...
            .then(() => {
              logger.info(`The transaction with transactionId ${batchAndTx[1][0].headerSignature} is done.`)
              return { 
                success: true, 
                ...
                data: { txId: batchAndTx[1][0].headerSignature 
                } 
              }
            })
            .catch(err => {
              logger.error(`The transaction with transactionId ${batchAndTx[1][0].headerSignature} is not done.
